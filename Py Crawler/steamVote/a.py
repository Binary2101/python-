...
# offset+=10， page+=1
url = "https://steamcommunity.com/app/322330/homecontent/?userreviewsoffset={offset}&p={page}&workshopitemspage={page}&readytouseitemspage={page}&mtxitemspage={page}&itemspage={page}&screenshotspage={page}&videospage={page}&artpage={page}&allguidepage={page}&webguidepage={page}&integratedguidepage={page}&discussionspage={page}&numperpage=10&browsefilter=mostrecent&browsefilter=mostrecent&appid=322330&appHubSubSection=10&appHubSubSection=10&l=schinese&filterLanguage=english&searchText=&forceanon=1"
...
for i in range(1, 21):
    ...
    votes = soup.find_all("div", "apphub_CardTextContent")
